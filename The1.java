...
public class The1 {
        ...
        public static Stack<Integer> stackPush(Stack<Integer> stack){
            for(int i = 0; i < 5; i++)
            {
                Integer push = (Integer) stack.push(i); System.out.println(push);
            }
        return stack; }
    public static void pop(Stack<Integer> stack)
    {
        for(int i = 0; i < 5; i++){
        Integer pop = (Integer) stack.pop(); System.out.println(pop);
        }
    }
    ...
    {
        stack2 = stackPush(stack1); System.out.println("Stack transfered successfully: "+ stack2);
        return stack2;
    }
    ...
    public static void main(String[] args) {
        ...
        Stack<Integer> stack2 = new Stack<>(); Stack<Integer> finalStack = transfer(stack1, stack2);
}
}